...
/* ===== GSAP  ====== */
gsap.from('.home__img', { opacity: 0, duration: 2, delay: .3, x: 60 })
...
gsap.from('.nav__item', { opacity: 0, duration: 2, delay: 1.25, y: 25, ease: 'expo.out', stagger: .2 })
